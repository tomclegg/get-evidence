...
$gQualityAxes = array ("Computational" => "Average of predictions generated by SIFT, PolyPhen, and NBLOSUM",
...
function editable_quality ($id, $content, $title, $options)
{
	...
	$html .= "<TR>\n";
	$html .= "<TD class=\"rowlabel nowrap\"><SPAN onmouseover=\"Tip('$desc',BALLOON,true,FIX,[this,0,0],FOLLOWMOUSE,false,ABOVE,true);\" onmouseout=\"UnTip();\">$axis</SPAN></TD>\n";
